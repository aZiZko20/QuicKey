...
int keyboard[6][14] = {
                      ...
                      {0xC1, 0x61, 0x73, 0x64, 0x66, 0x67, 0x68, 0x6A, 0x6B, 0x6C, 0x3B, 0x22, 0xB0      }, //13 columns here
                      {0x81, 0x7A, 0x78, 0x63, 0x76, 0x62, 0x6E, 0x6D, 0x2C, 0x2E, 0x2F, 0x85            }, //12 columns here
                      {0x80, 0x83, 0x82,     0x20     , 0x86, 0xDA, 0x84, 0xD8                           }, //FN turned to LEFT arrow button and Menu turned to UP arrow. 8 columns here
                      {0x00, 0x00, 0x00, 0x00, 0x7B, 0x28, 0x3C, 0x3E, 0x29, 0x7D, 0x00, 0x00, 0x00, 0x00}
                      };
                      

int port_rows[6] = {18, 19, 20, 21, 22, 23};
int port_cols[14] = {0, 1, 2, 3, 5, 8, 9, 10, 13, 14, 15, 16, 17, 30};
...
int keyboard_scan(){
  ...
  return 0xFFF; //If nothing is found, return 0xFFF
}
